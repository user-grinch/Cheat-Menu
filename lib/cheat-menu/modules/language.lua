...
local tlanguage = 
{
    ...
    names    = {},
    list     = {},
    path  =  getGameDirectory() .. "//moonloader//lib//cheat-menu//languages//"
}
...
function module.LoadLanguages()
    ...
    if not pcall(LoadCurrentLanguage) then
        printString("~r~Unable~w~ to load language : " .. tlanguage.current,1000)
    end
end
