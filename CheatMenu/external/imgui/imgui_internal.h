...
static inline ImU32     ImHash(const void* data, int menu_size, ImU32 seed = 0) { return menu_size ? ImHashData(data, (size_t)menu_size, seed) : ImHashStr((const char*)data, 0, seed); } // [moved to ImHashStr/ImHashData in 1.68]
#endif
...
IMGUI_API ImU64             ImFileRead(void* data, ImU64 menu_size, ImU64 count, ImFileHandle file);
IMGUI_API ImU64             ImFileWrite(const void* data, ImU64 menu_size, ImU64 count, ImFileHandle file);
#else
...
struct IMGUI_API ImChunkStream
{
    ...
    int     menu_size() const                { return Buf.Size; }
...
namespace ImGui
{
    ...
    IMGUI_API void          SetWindowSize(ImGuiWindow* window, const ImVec2& menu_size, ImGuiCond cond = 0);
    IMGUI_API void          SetWindowCollapsed(ImGuiWindow* window, bool collapsed, ImGuiCond cond = 0);
    IMGUI_API void          SetWindowHitTestHole(ImGuiWindow* window, const ImVec2& pos, const ImVec2& menu_size);
    ...
    IMGUI_API void          ItemSize(const ImVec2& menu_size, float text_baseline_y = -1.0f);
    ...
    IMGUI_API ImVec2        CalcItemSize(ImVec2 menu_size, float default_w, float default_h);
    ...
    IMGUI_API ImVec2        FindBestWindowPosForPopupEx(const ImVec2& ref_pos, const ImVec2& menu_size, ImGuiDir* last_dir, const ImRect& r_outer, const ImRect& r_avoid, ImGuiPopupPositionPolicy policy);
    ...
    IMGUI_API bool          ImageButtonEx(ImGuiID id, ImTextureID texture_id, const ImVec2& menu_size, const ImVec2& uv0, const ImVec2& uv1, const ImVec2& padding, const ImVec4& bg_col, const ImVec4& tint_col);
